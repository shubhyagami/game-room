...
A lightweight, real‑time multiplayer platform for browser‑based game nights.  
Host lobby‑managed, turn‑based games—trivia, cards, strategy—with live scores and optional spectator chat.
...
- **Lobby Management** – Create rooms, share invite links, and control player settings.  
...
4. **Open** `http://localhost:3000` in a browser and share the generated invite link to start playing.
...
- Manage player joins, leaves, and settings directly from the lobby interface.
